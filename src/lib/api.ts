...
export interface OrderActivity {
  geraCertificado?: boolean;
  servicoSnapshot?: { epis?: string[]; normasAplicaveis?: string[]; procedimentos?: string[]; checklistItens?: string[] };
  produtosDetalhados?: Array<{nome: string; qtUso?: string}>;
  id: string;
  servicoId: string;
  servicoNome?: string;
  quantidade: number;
  ...
  fotos: string[];
  produtosUtilizados: Array<{ produtoId: string; quantidade: number }>;
...
export const closeOrder = (id: string, payload: { atividades?: OrderActivity[]; dataExecucao: string; quantidade?: number; tagEquipamentoServico?: string; fotos?: string[]; checklistRespostas?: OSApp["checklistRespostas"]; naoExecutada?: boolean; motivoNaoExecucao?: string; produtosUtilizados?: Array<{ produtoId: string; quantidade: number }> }) =>
