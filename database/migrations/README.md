...
- `028_avulso_agendamento_servico_catalogo.sql`: permite agendamentos e recorrencias sem contrato, mantendo o servico do catalogo para rastreabilidade e sem consumir saldo contratual.
